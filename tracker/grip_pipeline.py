...
class Pipeline:
    """OpenCV pipeline generated by GRIP"""

    def __init__(self):
        """initializes all values to presets or None if need to be set"""

        # self.__hsv_threshold_hue = [55.03597122302158, 103.20819112627986]
        # self.__hsv_threshold_saturation = [155.93525179856115, 255.0]
        # self.__hsv_threshold_value = [130, 255.0]

        self.__hsv_threshold_hue = [0.0, 180.0]
        self.__hsv_threshold_saturation = [0, 70.0]
        ...
        self.__filter_contours_solidity = [30, 100]
    ...
    def __filter_contours(input_contours, min_area, min_perimeter, min_width, max_width,
        ...
        Args:
            ...
            min_area: The min area of a contour that will be kept.
            min_perimeter: The min perimeter of a contour that will be kept.
            min_width: Min width of a contour.
            max_width: Max width maximum width.
            min_height: Min height.
            max_height: Max height.
            solidity: The min and max solidity of a contour.
            min_vertex_count: Min vertex Count of the contours.
            max_vertex_count: Max vertex Count.
            min_ratio: Min ratio of width to height.
            max_ratio: Max ratio of width to height.
        Returns:
        ...
        for contour in input_contours:
            ...
            if (solid < solidity[0] or solid > solidity[1]):
                continue
            if (len(contour) < min_vertex_count or
